...
export const featureFlagEvaluation = pgTable("feature_flag_evaluation", {
  id: uuid("id").primaryKey().defaultRandom(),
...
export const announcementAcknowledgment = pgTable("announcement_acknowledgment", {
  id: uuid("id").primaryKey().defaultRandom(),
  ...
  uniqueIdx: unique("announcement_acknowledgment_unique_idx").on(
    table.announcementId,
    table.userId,
  ),
  announcementIdx: index("announcement_acknowledgment_announcement_idx").on(
    table.announcementId,
  ),
