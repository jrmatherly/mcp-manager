...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'data-gradient-dark': 'linear-gradient(135deg, rgba(59, 130, 246, 0.1) 0%, rgba(147, 51, 234, 0.1) 50%, rgba(236, 72, 153, 0.1) 100%)',
      },
      boxShadow: {
  ...
  plugins: [
    ...
    // Custom plugin for 3D transforms and glassmorphism utilities
