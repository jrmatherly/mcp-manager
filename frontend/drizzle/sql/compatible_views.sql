-- Compatible Monitoring Views for Current Schema
-- These views work with the existing table structure
...
ORDER BY priority_order, el.occurred_at DESC
LIMIT 100;
